"""
Django settings for craft_shack project.
...
SECRET_KEY = 'django-insecure-@#@t3n%6g23$x%aulhg+@i@*lcc80(_k3ntuva$3zyb#8q7urc'
...
# additional settings required by allauth so copied from allauth documentation
...
# required by allauth so copied from tutorial documentation
SITE_ID = 1
...
WSGI_APPLICATION = 'craft_shack.wsgi.application'
...
# Auto calculating free delivery and delivery costs
